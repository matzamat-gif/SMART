...
1. קבע מה מוצג. אם אין בתמונה פירות או ירקות כלל (אדם, חדר, מסך, חפץ) — החזר {"items":[]} בלבד. לעולם אל תמציא מוצר. שים לב: שלטי מחירים, מספרים, ארגזים ריקים ומשקלים אינם מוצרים.
2. זהה את המוצר לפי צבע, צורה, מרקם, גבעול ועלים. השווה לקטלוג שבהמשך. אם אתה מתלבט בין שני מוצרים — בחר את הסביר יותר והורד את הביטחון בהתאם. אל תדווח מוצר שאינך מזהה בבירור.
   היזהר במיוחד מזוגות דומים — אל תעלה מעל 0.6 ביטחון כשלא ניתן להבחין ביניהם בוודאות:
